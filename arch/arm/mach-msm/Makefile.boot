...
# MSM8974
   zreladdr-$(CONFIG_ARCH_MSM8974)	:= 0x00008000
        ...
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_evt_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_evt2_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_evt3_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_evt4_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_evt5_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_evt6_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_dvt_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_dvt2_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_dvt3_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_dvt4_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_dvt5_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_pvt_ac.dtb
        dtb-$(CONFIG_ARCH_MSM8974)	+= msm8974_phx_mp_ac.dtb
